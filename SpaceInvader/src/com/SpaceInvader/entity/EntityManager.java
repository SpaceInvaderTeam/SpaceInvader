...
import com.SpaceInvader.invaders.camera.OrthoCamera;
import com.SpaceInvader.invaders.screen.GameOverScreen;
import com.SpaceInvader.invaders.screen.ScreenManager;
...
public class EntityManager {
	...
	public EntityManager(int amount, OrthoCamera camera) {
		...
		for (int i = 0; i < amount; i++) {
			...
			float speed = MathUtils.random(2, 2);
